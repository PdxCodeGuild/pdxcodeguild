...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'theme_homepage', 'featured_portfolio',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portfolio.Portfolio'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomePage.max_portfolio_items'
        db.add_column(u'theme_homepage', 'max_portfolio_items',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=6, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HomePage.max_portfolio_items'
        db.delete_column(u'theme_homepage', 'max_portfolio_items')
