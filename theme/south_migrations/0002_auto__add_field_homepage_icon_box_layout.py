...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.icon_box_layout'
        db.add_column(u'theme_homepage', 'icon_box_layout',
                      self.gf('django.db.models.fields.CharField')(default='TH', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.icon_box_layout'
        db.delete_column(u'theme_homepage', 'icon_box_layout')
