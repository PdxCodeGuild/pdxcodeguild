...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteConfiguration.contact_iframe'
        db.add_column(u'theme_siteconfiguration', 'contact_iframe',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'SiteConfiguration.contact_iframe_layout'
        db.add_column(u'theme_siteconfiguration', 'contact_iframe_layout',
                      self.gf('django.db.models.fields.CharField')(default='FULL', max_length=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteConfiguration.contact_iframe'
        db.delete_column(u'theme_siteconfiguration', 'contact_iframe')

        # Deleting field 'SiteConfiguration.contact_iframe_layout'
        db.delete_column(u'theme_siteconfiguration', 'contact_iframe_layout')
