...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_mods_blogpostimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('blog_post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['blog.BlogPost'])),
        ...
        db.send_create_signal(u'blog_mods', ['BlogPostImage'])


    def backwards(self, orm):
        # Deleting model 'BlogPostImage'
        db.delete_table(u'blog_mods_blogpostimage')
    ...
    models = {
        ...
        u'blog.blogpost': {
            ...
            'featured_video': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'blank': 'True'}),
        ...
        u'blog_mods.blogpostimage': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'BlogPostImage'},
            '_order': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'alt_text': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'blog_post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': u"orm['blog.BlogPost']"}),
